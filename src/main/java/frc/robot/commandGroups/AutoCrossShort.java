...
public class AutoCrossShort extends SequentialCommandGroup {
  /** Creates a new AutoBlueLeft. */
  public AutoCrossShort(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveOdometry(_drive, new Pose2d(Units.inchesToMeters(60),0,new Rotation2d(Math.toDegrees(0))), 2)       // Cross Line Far
