...
public class AutoSourceShootGoWall extends SequentialCommandGroup {
  /** Creates a new AutoBlueLeft. */
  public AutoSourceShootGoWall(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveOdometry(_drive, new Pose2d(Units.inchesToMeters(64),Units.inchesToMeters(-96),new Rotation2d(Math.toDegrees(0))), 4)  // Drive to Note
