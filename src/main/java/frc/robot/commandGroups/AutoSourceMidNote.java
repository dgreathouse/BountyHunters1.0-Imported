...
public class AutoSourceMidNote extends SequentialCommandGroup {
  ...
  public AutoSourceMidNote(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveOdometry(_drive, new Pose2d(0,0 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 2),       // Drive to Mid area
      new InstantCommand(_intake::spinOn),                                                                         // Turn on the intake
      new AutoDriveOdometry(_drive, new Pose2d(0,0 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 2),       // Drive to Note
