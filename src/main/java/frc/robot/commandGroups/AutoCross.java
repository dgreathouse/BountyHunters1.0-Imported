...
public class AutoCross extends SequentialCommandGroup {
  /** Creates a new AutoBlueLeft. */
  public AutoCross(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveOdometry(_drive, new Pose2d(2,0,new Rotation2d(Math.toDegrees(0))), 2)       // Cross
