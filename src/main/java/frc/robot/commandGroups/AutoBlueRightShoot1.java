...
public class AutoBlueRightShoot1 extends SequentialCommandGroup {
  ...
  public AutoBlueRightShoot1(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveTimeVel(_drive,2, 0,0, 1.8, 0.2 , 0.3, false),
      ...
      new AutoDriveRotateCommand(_drive, -16.5, 1.0),
      ...
      new AutoDriveTimeVel(_drive, 2, -16.5, -16.5, 2.2, 0, 0.2, false),
      new AutoDriveDelayCommand(_drive, 0.8),
      new AutoDriveTimeVel(_drive,2, 163.5,-40, 2.3, 0.2 , 0.2, false),
      new AutoDriveDelayCommand(_drive, 0.8),
