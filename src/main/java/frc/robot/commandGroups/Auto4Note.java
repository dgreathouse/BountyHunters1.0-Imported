...
public class Auto4Note extends SequentialCommandGroup {
  public Auto4Note(DrivetrainSubsystem _drive, ShooterSubsystem _shooter, IntakeSubsystem _intake) {
    ...
    addCommands(
      ...
      new AutoDriveOdometry(_drive, new Pose2d(0.813,0.1524,new Rotation2d(Math.toDegrees(0))), 1.85),                        // Drive back
      ...
      new AutoDriveOdometry(_drive, new Pose2d(0.8128,-0.357 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),   // Drive back to Note at angle
      new AutoDriveOdometry(_drive, new Pose2d(1.65,-0.307 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),     // Drive back to Note at angle
      ...
      new FlipperSetCommand(_shooter, FlipperStates.BACK),                                                                    // Set flippers back
      new AutoDriveRotateCommand(_drive, 0, 1.0),                                                                             // Rotate to Straight
      new AutoDriveOdometry(_drive, new Pose2d(0.7112,-0.357 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),
      new AutoDriveOdometry(_drive, new Pose2d(0.7112,-1.8 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),    // Drive forward at angle
      new AutoDriveOdometry(_drive, new Pose2d(1.7,-1.8 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),       // Drive back to note at angle 
      ...
      new AutoDriveDelayCommand(_drive, 0.6),                                                                                // Delay for Note to be released
      new FlipperSetCommand(_shooter, FlipperStates.BACK),                                                                   // Set flippers back
      new AutoDriveOdometry(_drive, new Pose2d(0.7112,-3.2 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),   // Drive forward at angle
      new AutoDriveDelayCommand(_drive, 0.6), 
      new AutoDriveOdometry(_drive, new Pose2d(1.625,-3.2 * GD.G_AllianceSign,new Rotation2d(Math.toDegrees(0))), 1.85),    // Drive forward at angle
      new AutoDriveRotateCommand(_drive, -35 * GD.G_AllianceSign, 0.6),
      new FlipperSetCommand(_shooter, FlipperStates.SHOOT),                                                                  // Shoot Note #3
      new AutoDriveDelayCommand(_drive, 0.6),                                                                                // Delay for Note to be released
      new FlipperSetCommand(_shooter, FlipperStates.BACK), 
      new InstantCommand(_intake::spinOff),   
      new ShooterSetShotCommand(_shooter, ShooterState.OFF)          
